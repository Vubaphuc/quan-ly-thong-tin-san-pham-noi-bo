...
import hookWarrantyRegiterEngineer from "../../../hookForm/hook/hookWarranty/hookWarrantyRegisterEngineer";
...
function WarrantyProductDetail() {
  const { productId } = useParams();

  const { control, handleSubmit, errors, onRegisterEngineer } =
    hookWarrantyRegiterEngineer(productId);
    ...
    <>
      <section className="content">
        <div className="container-fluid">
          <form onSubmit={handleSubmit(onRegisterEngineer)}>
