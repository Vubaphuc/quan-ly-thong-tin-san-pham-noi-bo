...
import { useLazyFindProductWaitingRegisterGuaranteeAllQuery } from "../../../../../app/apis/receptionist/productApi";
import { getStatusLabel } from "../../../../formHTML/enum";

function RecepProductWaitingRegisterGuaranteeList() {
                                                ...
                                                <tbody>
                                                    {productData.data.map((product) => (
                                                        <tr key={product.id}>
                                                            <td>
                                                                <Link
                                                                    to={`/employee/receptionist/product-register-guarantee/${product.id}`}
...
export default RecepProductWaitingRegisterGuaranteeList;