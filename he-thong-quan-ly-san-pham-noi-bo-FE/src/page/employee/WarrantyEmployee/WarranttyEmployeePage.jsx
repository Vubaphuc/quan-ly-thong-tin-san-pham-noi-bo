...
import { useLazyFindProductGuaranteeStatusOKByTermQuery } from "../../../app/apis/warrantyEmployee/warrantyEmployeeApi";

function WarranttyEmployeePage() {
                        ...
                        <tbody>
                          {productData.data.map((product) => (
                            <tr key={product.productId}>
                              <td>
                                <Link
                                  to={`/employee/warranty/bill/create/${product.productId}`}
...
export default WarranttyEmployeePage;
